...
# RMSE_PM = np.sqrt(mean_squared_error(fc['CO2'],fc['forecast']))
# mape = deep_learner.mape(fc['CO2'],fc['forecast'])
# print(RMSE_PM)
# print(mape)

# yhat = deep_learner.predict_n_ahead(288)
...
# data = select("SELECT *  from airactual where date > current_timestamp - '5 days'::interval;", column_names)
# sc = MinMaxScaler()
# data = pd.DataFrame(data)
# data.index = data['date']
# data.index.name = None
# data_pred = data['temperature']
...
# data_pred_element = data_pred['temperature']
